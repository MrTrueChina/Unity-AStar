...
public class AStarWithOutClosedListDisplayObject : MonoBehaviour
{
    [SerializeField]
    ...
    void CreatAStar()
    {
        _aStar = new AStarWithOutClosedList(_width, _height);
    }
    ...
    float GetMaxStartToCost()
    {
        ...
        foreach (AStarWithOutClosedListNode node in _aStar.matrix)
