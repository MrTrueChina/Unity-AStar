...
public class AStarEightDirectionsDisplayObject : MonoBehaviour
{
    [SerializeField]
    ...
    void CreatAStar()
    {
        _aStar = new AStarEightDirections(_width, _height);
    }
    ...
    float GetMaxStartToCost()
    {
        ...
        foreach (AStarEightDirectionsHeapNode node in _aStar.matrix)
